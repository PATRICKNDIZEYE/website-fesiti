...
export default function VisualizationPage() {
  ...
  return (
    <div className="space-y-6">
      <Header title="Visualization" subtitle="Dashboards, indicators, and trend analysis." />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {projects.map((project) => (
                    <Link
                      ...
                      className="bg-background border border-border rounded-lg p-4 hover:shadow-lg transition-shadow hover:border-primary/40"
                    >
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <BarChart3 className="w-5 h-5 text-primary flex-shrink-0 ml-2" />
                      </div>
