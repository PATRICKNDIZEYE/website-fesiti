...
export function AppTopNav({ orgId }: AppTopNavProps) {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/90 backdrop-blur" data-tour="top-nav">
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between gap-4 px-6">
          <div className="flex items-center gap-3">
            <Link href={getHref('dashboard')} className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <div className="text-sm font-semibold text-foreground">FESITI M&E Suite</div>
                <div className="text-xs text-muted-foreground">Enterprise monitoring workspace</div>
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2">
            <Badge className="hidden items-center gap-2 border border-primary/20 bg-primary/10 px-3 py-1 text-xs font-semibold text-primary lg:flex">
              Active programs
            ...
            <Link href={getHref('projects/new')} className="hidden lg:block" data-tour="create-project">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button className="hidden items-center gap-2 rounded-full border border-border bg-card px-2 py-1.5 text-left shadow-sm lg:flex">
                  ...
                  <div className="pr-2">
                    <div className="text-xs font-semibold text-foreground">{activeLabel}</div>
                    <div className="text-[11px] text-muted-foreground">Workspace actions</div>
                  </div>
                </button>
              </PopoverTrigger>
